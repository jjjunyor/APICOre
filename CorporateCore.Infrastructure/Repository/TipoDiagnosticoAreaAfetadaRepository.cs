...
{
    public class TipoDiagnosticoAreaAfetadaRepository : EFRepository<TipoDiagnosticoAreaAfetada>, ITipoDiagnosticoAreaAfetadaRepository
    {
        private readonly CorporateContext context;
        public TipoDiagnosticoAreaAfetadaRepository(CorporateContext aval) : base(aval)
        {
            this.context = aval;
        }
